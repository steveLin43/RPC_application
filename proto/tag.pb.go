...
var file_proto_tag_proto_rawDesc = []byte{
	...
	0x79, 0x22, 0x00, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b, 0x70,
...
func file_proto_tag_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_tag_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Tag); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_tag_proto_msgTypes[2].Exporter = func(v any, i int) any {
